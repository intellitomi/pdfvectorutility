    ...
    def segment_text(self, text: str, max_length: int = 1000, overlap: int = 100) -> List[str]:
        ...
        while start < len(text):
            ...
            if end < len(text):
                ...
                if breakpoint > start:
                    end = breakpoint + 1  # Include the period/question mark/exclamation
...
class PDFToVectorPipeline:
    ...
    def process_pdf_file(
        ...
        Args:
            ...
            use_grobid: Whether to use Grobid for processing.
...
if __name__ == "__main__":
    ...
    config = {
        ...
        'pinecone_environment': 'us-east-1',  # Change to your environment
